...
class GradientDescent(Optimizer):
    ...
    def __init__(self, model, alpha=0.02, num_iters=500, min_cost=0, min_theta_diff=0, **options):
    ...
    def step(self, X, y):
        ...
        :return:
        """
        # TODO zavolat grad přenásobit alphou a odečíst od thety (theta - alpha*zlazavorka)
